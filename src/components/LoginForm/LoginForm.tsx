...
const LoginForm = () => {
    ...
    return (
        <form className="py-10 w-full" autoComplete="on" onSubmit={handleSubmit(onSubmit)}>
                ...
                <Controller
                    ...
                    render={({ field }) => (
                        <InputField
                            ...
                            type="email"
                            autoComplete="email"
                            className="border-1 w-full border-pale-steel"
            ...
            <div className="flex flex-row justify-between w-full pb-10">
                <Controller
                    ...
                    render={({ field }) => (
                        <CheckBox
                            ...
                            labelClassName="text-base font-normal text-neutral-gray"
                ...
                <div className="relative">
                    <a href="/" className="text-dark-teal ">Forgot Password? </a>
                    <span className="absolute w-full border-dark-teal border-[0.5px] bottom-[5px] left-0" />
                </div>
            </div>
            <Button type="submit" className="bg-teal-green font-semibold text-xl w-full text-white py-8">{"Sign in"}</Button>
        </form>
    );
};
